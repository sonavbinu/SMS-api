...
const getServerUrl = () => {
    if (NODE_ENV === 'production') {
        return (process.env.RENDER_EXTERNAL_URL || 'https://sms-api-ne6y.onrender.com');
    }
...
const options = {
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description: 'Complete API documentation for SMS service with OTP, Alerts, and Promotions using Fast2SMS',
            contact: {
                name: 'API Support',
